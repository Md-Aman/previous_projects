'''
Name   :   CustomerProfileInit
Usage  :   Gets the list of countries,businesses,industries
...
class CustomerProfileInitResource__v1__(object):
    ...
    def on_get(self, req, resp, login_id, session):
        ...
        # if Authenticated then the code below runs
        # Gets List
        try:
