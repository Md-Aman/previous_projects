...
class CustomerProfileUploadFile__v1__(object):
            ...
            for item in req.params:
                if item=='importExportLicenseUploader':
                    ...
                    if(fileitem.file):
                        ...
                        #     cursor.execute("UPDATE customers SET customers.import_export_license = '"+fn+"' WHERE customers.login_id = '"+importExport+"';")
            ...
            for item in req.params:
                if item=='businessLicenseUploader':
                    ...
                    if(fileitem.file):
                        ...
                        #         password=dbconfig['password'], database=dbconfig['database'])
                        #     cursor = database_connection.cursor()
                        #     cursor.execute("UPDATE customers SET customers.business_license = '"+fn+"' )
                        #     database_connection.commit()
