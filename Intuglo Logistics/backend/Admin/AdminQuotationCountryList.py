...
class AdminQuotationCountryListResource__v1__(object):
    def on_get(self, req, resp, login_id, session):
        ...
        try:
            ...
            # Query to display this data from this tbl w qt_status_id criteria
            list_of_booking_query = ("select q.country, count(q.quotation_id) as Count\
