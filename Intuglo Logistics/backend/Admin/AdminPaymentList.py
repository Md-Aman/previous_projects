...
class AdminPaymentListResource__v1__(object):
    def on_get(self, req, resp, login_id, session, vessel_id):
        ...
        try:
            ...
            sql = ("select DATE_FORMAT(o.booking_date,'%d/%m/%Y') as booking_date,o.created_on, l.supplier_name, q.quotation_id, o.order_id , c.customer_name, o.closing_price_total\
                    from ship_orders o\
                    ...
                    where q.vessel_id = '"+vessel_id+"' and o.payment_status_code = 'CONFIRMPAYMENTAMOUNT' and q.payment_status = 'CONFIRMED'")
            cursor.execute(sql)
            row = cursor.fetchall()
