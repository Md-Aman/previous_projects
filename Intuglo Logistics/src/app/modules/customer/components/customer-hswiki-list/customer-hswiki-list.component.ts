...
@Component({
  selector: 'customer-hswiki-list',
  templateUrl: './customer-hswiki-list.component.html',
  styleUrls: ['./customer-hswiki-list.component.css']
})
export class CustomerHswikiListComponent implements OnInit {
