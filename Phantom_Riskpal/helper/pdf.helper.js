...
var footerfunc = `function(pageNum, numPages) {                 
                    return "<hr><div ><span style='text-align:center;font-size:10px;margin-bottom: 20px !important;'>
                    <b>Approval Date:</b>"
                    + new Date() +
                    ' <b>Final Approving Manager: </b>` + approvingManagerName + `</span></div>';
                }`;
module.exports.createPdf = function(newsRa, countryMatrixData, graph, type = 'submitRaToManager' ) {
        ...
        var leven = `
        <div style="display: table;page-break-after:always;"></div>
        <div class="" style="
                position: relative;
                
                text-align: center;
                width: 100%;background-color: #000;height: 27cm;">
                <img class="bg" style="position:absolute;top: 0px !important;left: -50px;" 
                ...
                <div class="row" style="position: absolute; top: 0;left : 0;right: 0;bottom: 0;margin: auto;height: 260px">
                    ...
                    <div class="col-md-12" >
                        <img style="width: 229px;height: 135px;    margin-bottom: 78px;" src="https://s3.eu-west-2.amazonaws.com/riskapl-images/public/logo.png" />
                        ...
                        <p class="fnt-17">
                            ...
                            <span class="primary-color">${countryArr}</span>
                        </p>
                    </div>
                </div>
            </div>
        <section class="content" style="display: block;margin:20px !important;" id="myTemplate">
            
            
            <div class="">  
                <div class=""> 
                    <div style="display: table; page-break-after: always;"></div>
                    <div class="box box-primary traveltest" style="height: 27cm;"> 
                            ...
                            <div class="row"> 
                                <div class="col-xs-12"> 
                                    <div class="form-group"> 
                                        ...
                                        <p class="p-brdr">${departmentArray}</p> 
                                    </div> 
                                </div> 
                            </div> 
                            <div class="row"> 
                                ...
                                <div class="col-xs-3"> 
                                    <div class="form-group"> 
                                        ...
                                        <input class="form-control" id="StartDate" title="Start Date" 
                                            ...
                                            value="${newsRa.startdate}" disabled placeholder="Date of RA"> 
                                    </div> 
                                </div> 
                                <div class="col-xs-3"> 
                                    <div class="form-group"> 
                                        ...
                                        <input class="form-control" id="enddate" title="End Date"
                                            ...
                                            value="${newsRa.enddate}" disabled placeholder="End Date"> 
                                    </div> 
                                </div>
                                </div>
                            </div>`;
        ...
        aftlabel += '<div class="row"> <div class="col-xs-12"> <div class="form-group"> <label for="TaskDescription">Task Description</label> <div  class="paragraph-style">' + newsRa.description_of_task + '</div></div> </div> </div> <br/> <div class="row"> <div class="col-xs-12"> <label for="TaskDescription">Itinerary Description</label> <div class="paragraph-style" >' + newsRa.itineary_description + '</div> </div> </div> <br/>';
        if (newsRa.types_of_ra_id.countryrequired == true) {
            ...
            countryMatrixData.forEach((item, key) => {
                ...
                if (item.country_id.color == "amber") {
                    ...
                    var inputstyle = 'style="color: #E0C055 !important;border: 1px solid #E0C055 !important"';
                } else if (item.country_id.color == "red") {

                    countrycolorname = "Red";

                    inputstyle = 'style="color:#E24040 !important;border: 1px solid #E24040 !important;"';
                    ...
                    inputstyle = 'style="color:#71BE68 !important;border: 1px solid #71BE68 !important;"';
                }
                    ...
                    <div class="row"> 
                        <div class="col-xs-12"> 
                            <div class="form-group"> 
                                ...
                                <p align="justify">${checkSecurity}</p>
                            </div> 
                        </div> 
                    </div> 
                    </div> </div><br />`;
        ...
        var travellerdiv = `<div style="margin:20px !important;display : table !important; page-break-after: always;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
            
            <div class="box box-primary traveltest" style=""> 
            <div class="box-header with-border"> 
            <h4 class="box-title" >
                Section 2: Traveller Details</h4> 
                <hr class="brdr-top">
            </div> 
            <div class="box-body" style="width:100% !important;">
                ...
                <div class="row"> <div class="col-xs-4"> 
                    <div class="form-group"> 
                        <label for="travellerFirstName">Name</label>
                        <input class="form-control" id="travellerFirstName" title="Traveller First Name" type="text" class="form-control" 
                            ng-model="raData.traveller_id.firstname" value="${traveller.firstname} ${traveller.lastname}" disabled placeholder="Traveller First Name"> 
                    </div>
                </div>
            <div class="col-xs-5"> 
            <div class="form-group"> 
            ...
            <input class="form-control" id="Email" title="Traveller Email" type="text" class="form-control" 
                value="${traveller.email}" disabled placeholder="Email">
            </div> </div> 
            <div class="col-xs-3">
                 <div class="form-group"> 
                 <label for="MobileNumber">Mobile Number</label>
                  <input class="form-control" id="MobileNumber" title="Mobile Number" type="text" class="form-control" 
                    value="${traveller.mobile_number}" disabled placeholder="Mobile Number"> </div> </div> </div>`;
            ...
            if (newsRa.travellerTeamArr.length > 0) {
                ...
                othertravellerdiv += `<br><br><br>
                    <div class="box box-primary" > 
                        ...
                        <div class="box-body">
                        <div class="accord" style="    height: 66px !important;">
                            <h6 class="heading-page">Other Traveller:</h6> 
                        </div>`;
            }
        ...
        if (newsRa.types_of_ra_id.supplierRequired == true) {
            ...
            var supplier_details = `
                <div style="display : table !important;page-break-after: always;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div class="box box-primary" style="display : table !important;page-break-after: always;"> 
                    <div class="box-header with-border">
                         
                        <h4 class="box-title">
                            Section 3: Logistics<hr class="brdr-top">
                        </h4>
                    </div> 
                    <div class="box-body">`;
            ...
            supplierData.forEach(function (supplier, index) {
                ...
                if ( index != 0 ) {
                    supplier_details += `<hr class="brdr-top-dotted">`;
                }
                supplier_details += `
                    <div class="row" ng-repeat="supplier in supplier"> 
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                ...
                                <input class="form-control" id="sName" type="text" 
                                    placeholder="Name" disabled value="${supplier.supplier_name}" title="Name">
                            </div>
                        </div> 
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                ...
                                <input class="form-control" id="ServiceProvided" type="text" 
                                    placeholder="Service Provided" disabled title="Service Provided" 
                        ...
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                ...
                                <input class="form-control" type="text" id="ContactNumber" 
                                    placeholder="Contact Number" disabled title="Contact Number" 
                        ...
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                ...
                                <input class="form-control" type="text" id="ContactNumber" 
                                    placeholder="Email" disabled title="Contact Number" 
                        ...
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                ...
                                <input class="form-control" id="sCountry" type="text" 
                                    placeholder="Country" disabled value="${supplier.country}" 
                                    title="Country">
                            </div>
                        </div> 
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                <label for="sCountry">City</label> 
                                <input class="form-control" id="sCountry" type="text" 
                                    placeholder="City" disabled value="${supplier.city}" 
                                    title="Country">
                            </div>
                        </div> 
                        <div class="col-xs-6"> 
                            <div class="form-group"> 
                                <label for="sCost">Cost per Day</label> 
                                <input class="form-control" id="sCost" type="text" placeholder="Cost" 
                                    disabled title="Cost" value="${supplier.cost}"> 
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="sCurrency" type="text" 
                                    placeholder="Currency" disabled title="Currency" 
                ...
                if (typeof supplier.sourcing != "undefined" && (supplier.sourcing != null) && supplier.sourced_by == null) {
                    supplier_details += `
                        <div class="col-xs-12"> 
                            <div class="form-group"> 
                                <label for="sCurrency">Sourcing</label> 
                                <input class="form-control" id="sCurrency" type="text" 
                                    placeholder="Sourcing" disabled title="Currency" 
                    ...
                    if (supplier.sourcing == "other") {
                        ...
                        supplier_details += `
                            <div class="col-xs-12">
                                <div class="form-group"> 
                                    <label for="sCurrency">Other Information</label> 
                        ...
                        supplier_details += `
                            <div class="col-xs-12">
                                <div class="form-group"> 
                                    <label for="sCurrency">Recommended by</label> 
                                    <input class="form-control" id="sName" type="text" 
                                        placeholder="Name" disabled value="${supplier.who_recommended}"
                                        title="Name"> 
                                </div> 
                            </div> </br>`;
                    ...
                    supplier_details += `
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label for="sCurrency">Recommended by</label>
                                <input class="form-control" id="sName" type="text" placeholder="Name" 
                                    disabled value="${supplier.sourced_by}" title="Name">
                            </div>
                        </div>`;
            ...
            if (typeof supplierData.description != "undefined" && supplierData.description != "null") {
                ...
                supplier_details += `
                    <div class="col-xs-12"> 
                        <div class="form-group"> 
                            <label for="sCurrency">Description</label> 
                            <p align="justify">${supplierData.description}</p> 
                        </div>
                    </div>`;
        ...
        if (newsRa.types_of_ra_id.communicationRequired == true) {
            ...
            communication_details += ' <br/><br/><div style="diplay : block !important">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> <h4 class="box-title">Section ' + sno_comm + ': Communications<hr class="brdr-top" > </h4> <div class="accord"><h6 class="heading-page">Team Contacts:</h6></div>';
            ...
            communicationData.forEach(function (communicationd) {
                ...
                if (Array.isArray(communicationd.call_intime)) {
        ...
        if (newsRa.types_of_ra_id.questionRequired == true || newsRa.types_of_ra_id.contingenciesRequired == true) {
            ...
            if (newsRa.types_of_ra_id.contingenciesRequired == true) {
                ...
                var contigencieshtml = '<div style="display: table;page-break-after:always">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class=""><div class="box box-primary"> <div class="box-header with-border"><div style="diplay : block !important">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> <h4 class="box-title">Section ' + sno_cont + ': Contingencies <hr class="brdr-top"></h4> </div> <div class="box-body">';
                ...
                contingencyData.forEach(function (contingency) {
                    ...
                    contigencieshtml += `
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="MedicalProvision" type="text" 
                                        disabled value="${contingency.medical_provision}" 
                            ...
                            <div class="col-xs-6">
                                <div class="form-group"> 
                                    ...
                                    <input class="form-control" id="Evacuation" type="text" 
                                        placeholder="Method Of Evacuation" disabled 
                        ...
                        <div class="row"> 
                            <div class="col-xs-6"> 
                                <div class="form-group"> 
                                    <label for="NearestHospital">Local Hospital Information</label> 
                                    <input class="form-control" id="NearestHospital" type="text" 
                                        placeholder="Detail Nearest Hospital" disabled 
                                        value="${detail_nearest_hospital}" 
                                        title="Detail Nearest Hospital">
                                </div>
                            </div> 
                            <div class="col-xs-6"> 
                                <div class="form-group"> 
                                    <label for="Medevac">Medical Evacuation Company</label> 
                                    <div class="paragraph-style p-brdr">${medevac_company}</div>
                                </div>
                            </div>
                        </div>`;
                    ...
                    contigencieshtml += `
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group"> 
                                    <label for="Medevac">Satellite Phone</label> 
                                    <input type="text" class="form-control" disabled value="${satellitePhone}" id="test3" /> 
                                </div> 
                            </div> 
                            <div class="col-xs-6">
                                <div class="form-group"> 
                                    <label for="Medevac">Tracker ID</label> 
                                    <input type="text" class="form-control" disabled value="${noOfTracker}" id="" />
                                </div>
                            </div> 
                        </div>`;
            ...
            if (newsRa.types_of_ra_id.questionRequired == true) {
                ...
                contigencieshtml += `<br />
                    <div style="display: table;page-break-after:always;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    <div class="row" style=""> <div class="col-xs-12"> 
                        <div class="form-group"><h4 class="box-title">
                            Section ${sno_ques}: Risks and Mitigation<hr class="brdr-top"></h4> 
                ...
                queData.forEach(function (que) {
                    ...
                    if (que.ticked) {
                        ...
                        contigencieshtml += `<div class="risk-mit"><p class="head">${que.question}</p>
                        <div class="bpa">
                                <h1>Best Practice Advice</h1>
                                <div class="${smclass}">${que.best_practice_advice}</div>`;
                        if ( que.specific_mitigation != '') {
                            contigencieshtml += `<div>
                                    <h1>SPECIFIC MITIGATION</h1>
        ...
        if (newsRa.supporting_docs != null) {
            if (newsRa.supporting_docs.length > 0) {
                ...
                newsRa.supporting_docs.forEach(function (docs) {
                    ...
                    supporting_content += `<br /> 
                        <div class="row"> 
                            <div class="col-xs-6" style="margin-right: 10px;">
                            <a style="display: inline-block;" href="${link}" class="supp-doc">${img} ${docName} </a>
                            </div></div> </div> </div><br/>`;
                    count++;
        ...
        var otherinfodetails = '<div class=""><div class="box box-primary"> <div class="box-header with-border">   <div class="box-body"> <div class="row"> <div class="col-xs-12"><h4 class="box-title">Section ' + sno_anyother + ': Any Other Information<hr class="brdr-top"></h4> <div class="form-group"> <label for="relevant_info">Additional risks identified</label> <span> <p style="align:justify" class="p-brdr">' + newsRa.risk_detailed + '</p> </span> <span></span> </div> </div> </div> <div class="row"> <div class="col-xs-12"> <div class="form-group"> <label for="risk_detailed">Additional information provided</label> <span> <p style="align:justify" class="p-brdr">' + newsRa.relevant_info + '</p> </span> </div> </div> </div>';
